...
| TOUCH       | CY8CMBR3108         | Enabling capacitive touch functionality (interface through I2C) for user interaction, suitable for applications like musical instrument controls. 8 touchpoints available through an edge connector.     |
...
| ENCODER   | ESP32-S3-WROOM-1    | Enabling functionality for user interaction using rotary encorders (4x).                                     |
